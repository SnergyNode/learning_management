    ...
    <div class="split-vertical">
        ...
        <div class="sidebar-block">
            ...
            <div class="collapse" id="sidebar-course-info">
                ...
                <hr/>
                <a class="btn btn-white btn-sm paper-shadow relative" data-animated data-z="0.5" data-hover-z="1" href="#">Course details</a>
            </div>
        </div>
                        ...
                        <div class="media v-middle">
                            <div class="media-left">
                                <a href="" class="media-object">
                                    <img class="img-circle" src="{{ url('images/user.png') }}" alt="people" />
                                </a>
                            </div>
                            <div class="media-body">
                                <h4 class="sidebar-heading media-heading"><a href="">Tutor Name</a></h4>
                                <p>Tutor</p>
                            </div>
                        </div>
                    </div>
