            ...
            <div class="page-section">
                <div class="media media-grid v-middle">
                    <div class="media-left">
                        <span class="icon-block half bg-blue-700 text-white"><i class="fa fa-windows"></i></span>
                    </div>
                    <div class="media-body">
                        <h1 class="text-display-1 margin-none">Introduction to Microsoft Office</h1>
                    </div>
                </div>
                <br/>
            ...
            <div class="panel panel-default curriculum open paper-shadow" data-z="0.5">
                ...
                <div class="list-group collapse in" id="curriculum-1">
                    ...
                    <div class="list-group-item media active" data-target="#">
                        ...
                        <div class="media-body">
                            <i class="fa fa-fw fa-circle text-blue-300"></i> Licensing
                        </div>
                        <div class="media-right">
                    ...
                    <div class="list-group-item media" data-target="#">
                        ...
                        <div class="media-body">
                            <i class="fa fa-fw fa-circle text-grey-200"></i> Take Assessment
                        </div>
                        <div class="media-right">
            ...
            <div class="panel panel-default curriculum paper-shadow" data-z="0.5">
                ...
                <div class="list-group collapse" id="curriculum-2">
                    ...
                    <div class="list-group-item media" data-target="#">
                        ...
                        <div class="media-body">
                            <i class="fa fa-fw fa-circle text-grey-200"></i> Licensing
                        </div>
                        <div class="media-right">
                            <div class="width-100 text-right text-caption">25:01 min</div>
                        </div>
